...
public class TestStarWarSet {
    public void dumyData(){
        AddressUtil address=new AddressUtil();
        ...
        address.addAddress(a);
        address.addAddress(b);
        address.addAddress(c);
        address.addAddress(d);
        address.addAddress(e);
        address.addAddress(f);
        address.addAddress(g);
        address.addAddress(h);

        System.out.println(address.listUniqueContries());

        
        System.out.println(address.listUniqueStates());
